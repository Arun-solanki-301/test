...
const Addpoll = ({navigation})=>{
    ...
    return(
        <View style={{marginHorizontal : 25}}>
            <Text style={{fontSize : 25 , fontWeight : "bold" , color :"#1a73e8" , textAlign : "center", marginBottom : 15, marginTop : 20}}>Add Your Poll</Text>
            <View>
                <Text style={styles.label}> Enter poll title</Text>
                <TextInput  style={styles.formInputs} value={question} onChangeText={(e)=>setQuestion(e)}/>
                <Text style={styles.label}> option : 1</Text>
                <TextInput  style={styles.formInputs} value = {opt1} onChangeText={(e)=>setOpt1(e)}/>
                <Text style={styles.label}> option : 2</Text>
                <TextInput style={styles.formInputs} value = {opt2} onChangeText={(e)=>setOpt2(e)}/>
                <Text style={styles.label}> option : 3</Text>
                <TextInput  style={styles.formInputs} value = {opt3} onChangeText={(e)=>setOpt3(e)}/>
                <Text style={styles.label}> option : 4</Text>
                <TextInput  style={styles.formInputs} value = {opt4} onChangeText={(e)=>setOpt4(e)}/>
            </View>
            <View style={{display:"flex", flexDirection : "row" , justifyContent : "center"}}>
                <TouchableOpacity style={styles.submitForm} onPress={()=>OnpressSendData()}>
